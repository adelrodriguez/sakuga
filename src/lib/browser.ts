...
const getCanvasContext = Effect.fn(function* getCanvasContext(canvas: CanvasLike) {
...
const resolveFormat = Effect.fn(function* resolveFormat(
  format: BrowserFormat,
  height: number,
  width: number
) {
...
const resolveCanvas = Effect.fn(function* resolveCanvas(
...
export const renderVideoBrowser = Effect.fn(function* renderVideoBrowser(
  theme: string,
